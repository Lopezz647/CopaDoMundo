...
export default function UserHeader() {
  ...
  useEffect(() => {
    async function getUserData() {
      ...
      // 2. Busca o nome real na sua tabela 'profiles' (onde está o seu ranking)
  ...
  // Se estiver carregando, mostra um esqueleto para não quebrar o layout
  if (loading) return <div className="h-12 w-48 animate-pulse bg-white/5 rounded-lg mb-6" />;
  
  // Se não tem perfil, ele simplesmente não renderiza o Header do Usuário 
  // (Ou você poderia redirecionar aqui caso o perfil fosse obrigatório)
